...
Usage:
    python experiments/judges/strongreject_api_batch.py                 # submit + poll + merge
    python experiments/judges/strongreject_api_batch.py --dry_run       # build JSONL only, no API calls
    python experiments/judges/strongreject_api_batch.py --judge_model gpt-5.4-mini
"""
import argparse
import json
import os
