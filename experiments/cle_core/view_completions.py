...
Examples:
    python experiments/cle_core/view_completions.py --model_name llama3-8b
    python experiments/cle_core/view_completions.py --model_name llama3-8b --filter margin3.0
    python experiments/cle_core/view_completions.py --model_name llama3-8b --max_chars 0   # no truncation
"""
import argparse
import json
import re
