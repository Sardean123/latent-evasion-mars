...
Usage:
    python experiments/cle_core/harmless_mean_schedule.py --model_name llama3-8b --layers 11-18
    python experiments/cle_core/harmless_mean_schedule.py --layers 11-18 \
