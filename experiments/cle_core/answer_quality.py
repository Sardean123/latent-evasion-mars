...
Two design fixes over experiments/coherence/truthfulqa_fluency.py, which lets the judge free-generate and
...
Usage:
    python experiments/cle_core/answer_quality.py \
    ...
    python experiments/cle_core/answer_quality.py --runs ... --all          # judge every completion
    python experiments/cle_core/answer_quality.py --runs ... --judge_hf_id Qwen/Qwen2.5-14B-Instruct
"""
import argparse
import json
import os
