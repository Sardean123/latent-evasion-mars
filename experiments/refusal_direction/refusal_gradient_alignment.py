...
Usage:
    python experiments/refusal_direction/refusal_gradient_alignment.py --dry_run          # validate setup, no GPU
    python experiments/refusal_direction/refusal_gradient_alignment.py --layers 11-18 --dataset harmbench_test --limit 64
"""
import argparse
import json
import math
