...
Usage:
    python experiments/refusal_direction/plot_refusal_alignment.py
    python experiments/refusal_direction/plot_refusal_alignment.py --json <path> --out_tag harmbench_test
"""
import argparse
import json
import os
