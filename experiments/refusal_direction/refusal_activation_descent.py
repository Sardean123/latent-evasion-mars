...
Usage (defaults are deliberately small for a first run; tune lr / max_steps):
    python experiments/refusal_direction/refusal_activation_descent.py --limit 32 --max_steps 100 --lr 0.05
    python experiments/refusal_direction/refusal_activation_descent.py --compliance "Sure, here,Here's how,Sure, I can" \
