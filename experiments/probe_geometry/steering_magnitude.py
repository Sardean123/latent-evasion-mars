...
Usage:
    python experiments/probe_geometry/steering_magnitude.py --layers 11-18 --margins 0,0.5,1.0,1.5,2.0,2.5
    python experiments/probe_geometry/steering_magnitude.py --max_new_tokens 32   # also trace decoding
    # named per-layer schedules, one value per selected layer:
    python experiments/probe_geometry/steering_magnitude.py --layers 11-18 \
