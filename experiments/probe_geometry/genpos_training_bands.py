...
Consumed by experiments/probe_geometry/plot_over_generation_perpos.py, and by
...
Usage:
    python experiments/probe_geometry/genpos_training_bands.py --model_name llama3-8b --device cuda:0 --n_positions 8
"""
import argparse
import json
import os
