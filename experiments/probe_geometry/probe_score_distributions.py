...
Usage:
    python experiments/probe_geometry/probe_score_distributions.py --layers 11-18 --margin 1.5
    python experiments/probe_geometry/probe_score_distributions.py --layers 11-18 \
