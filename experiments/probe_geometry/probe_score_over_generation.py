...
Usage:
    python experiments/probe_geometry/probe_score_over_generation.py --layers 11-18 \
        --schedule 1.2,2.0,1.8,1.8,2.0,0.9,1.2 --max_new_tokens 8 --limit 200
    python experiments/probe_geometry/probe_score_over_generation.py --replot <saved.json>
"""
import argparse
import json
import os
